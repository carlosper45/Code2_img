    ...
    render() {
        ...
        return (
            <div>
                ...
                <div id="filter">
                    <label><input type="radio" name="filter" value="undefined" checked={this.state.filter==="undefined"} onChange={this.handleFilterChange.bind(this)}/> No filter</label>
                    <label><input type="radio" name="filter" value="grayscale" checked={this.state.filter==="grayscale"} onChange={this.handleFilterChange.bind(this)}/> Grayscale</label>
                    <label><input type="radio" name="filter" value="sepia" checked={this.state.filter==="sepia"} onChange={this.handleFilterChange.bind(this)}/> Sepia</label>
                </div>
